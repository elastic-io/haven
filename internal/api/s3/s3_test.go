...
func (m *MockS3Service) ListBuckets() ([]service.BucketInfo, error) {
	args := m.Called()
	return args.Get(0).([]service.BucketInfo), args.Error(1)
}
...
func (m *MockS3Service) ListObjects(bucket, prefix, marker, delimiter string, maxKeys int) ([]service.S3ObjectData, []string, error) {
	args := m.Called(bucket, prefix, marker, delimiter, maxKeys)
	return args.Get(0).([]service.S3ObjectData), args.Get(1).([]string), args.Error(2)
}

func (m *MockS3Service) GetObject(bucket, key string) (*service.S3ObjectData, error) {
	args := m.Called(bucket, key)
	return args.Get(0).(*service.S3ObjectData), args.Error(1)
}

func (m *MockS3Service) PutObject(bucket string, object service.S3ObjectData) error {
...
func (m *MockS3Service) CompleteMultipartUpload(bucket, key, uploadID string, parts []service.MultipartPart) (string, error) {
